...
| Date | Auteur | Description des changements | Détails / Fichiers impactés |Remaraques|
|------|---------|------------------------------|------------------------------||------------------------------|
| 2025-11-11 | @paguielng | Mis le fichier defaut des son avenir dans ./libs | ./libs ||> Les covers des sons à la une serons uploadé directement dans les dossier de l'artiste concérné|
...
| 2025-11-11 | @paguielng | Correction du système `featuredAlbums` pour l'affichage à la une | script.js ||
| … | … | … | … |
