...
| Date | Auteur | Descriptions | Fichiers | Remarques |
|------|---------|-----------------------------|------------------------------|------------|
...
| 2025-11-15 | @paguielng | Ajout des couleurs dans les `artistsConfig` des artistes | `script.js`, `style.css` | Ajout des coueleurs dynamiques. |
| … | … | … | … | … |
